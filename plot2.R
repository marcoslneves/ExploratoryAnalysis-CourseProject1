##########################################################################################################
## Coursera Exploratory Analysis Course Project 1 - Plot 2
...
# plot
par(mfrow = c(1,1))
with(data_bydate, plot(Datetime, Global_active_power, type = "l", col="black", main="", xlab = "", ylab="Global Active Power (kilowatts)"))
# close device
dev.off()